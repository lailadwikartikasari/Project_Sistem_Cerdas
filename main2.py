...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def show_classification_report(self):
        """Menampilkan classification report dari model yang telah dilatih."""
        ...
        try:
            ...
            # Resampling menggunakan SMOTEENN dan RandomUnderSampler (opsional jika diperlukan)
            smoteenn = SMOTEENN()
            ...
            report = classification_report(y_test, y_pred, target_names=self.model.classes_)

            # Cetak classification report ke dalam konsol atau tampilkan dalam GUI
            
            print("Classification Report:")
            print(report)

            # Jika ingin menampilkan dalam UI menggunakan QPlainTextEdit atau QDialog
            dialog = QtWidgets.QMessageBox(self)
            dialog.setWindowTitle("Classification Report")
